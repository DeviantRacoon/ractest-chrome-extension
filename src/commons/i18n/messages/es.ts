const es = {
  ...
  "sequence.new.urlLabel": "URL Inicial",
  "sequence.new.urlPlaceholder": "https://ejemplo.com/app",
  "sequence.new.urlHelper": "URL donde iniciará la secuencia. Se llena automáticamente con el primer flujo agregado.",
  ...
  "profile.finalValidation.label": "Activar validación final",
  "profile.finalValidation.helper":
    "Si está activado, RacTest verifica el resultado final de la página al terminar todos los pasos.",
